...
public class ChiefOfficer extends Employee {

	public ChiefOfficer(FullName fullName, Address address, Integer taxIdNumber, String gender, DateUtil dateOfBirth,
